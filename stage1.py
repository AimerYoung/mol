...
from data_provider.pretrain import PretrainDM
# from data_provider.stage1_kvplm_dm import Stage1KVPLMDM
# from data_provider.stage1_smol_dm import Stage1SmolDM
...
def main(args):
    ...
    # data
    if args.root.find('PubChem324kSP') >= 0:
        dm = PretrainDM(args.num_workers, args.batch_size, args.root, args.text_max_len, args.graph_aug, tokenizer,
                      args)
    # elif: args.root.find('kv') >= 0:
    #     dm = Stage1KVPLMDM(args.num_workers, args.batch_size, args.root, args.text_max_len, args.graph_aug, args)
    # else: # Smol
    #     dm = Stage1SmolDM(args.num_workers, args.batch_size, args.root, args.text_max_len, args.graph_aug, args)
    ...
    if len(args.devices.split(',')) > 1:
        ...
        strategy = strategies.DDPStrategy(find_unused_parameters=True, start_method='spawn')
    else:
        strategy = 'auto'
