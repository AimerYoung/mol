...
class TextEncoder(nn.Module):
    def __init__(self, pretrained=True):
        ...
        if pretrained:  # if use pretrained scibert model
            self.main_model = BertModel.from_pretrained('/home/zhongcl/momu_v2/Pretrain/bert_pretrained/')
        else:
    ...
    def forward(self, input_ids, attention_mask):
        ...
        # input_ids = input_ids.squeeze(1)  # Removes the second dimension if it is of size 1
