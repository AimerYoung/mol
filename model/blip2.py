...
class Blip2Base(BaseModel):
    ...
    def init_tokenizer(cls):
        if True:
            bert_name = '/home/holo/data/scibert_scivocab_uncased'
        else:
    ...
    def init_text_encoder(cls, num_layers, hidden_dim, device):
        text_encoder = GCNEncoder(768, 256, num_layers, PLACE_HOLDER='ENTITY', device=device)
        return text_encoder
